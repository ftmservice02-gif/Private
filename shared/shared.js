...
(function () {
  ...
  PM.I18N = {
    en: {
      ...
      "doc.scopedTo": "Showing documents for {title}",
      ...
      "cal.googleNone": "The imported calendar has no events in the dates shown here — use the arrows to look at other months.", "cal.today": "Today", "cal.mine": "My tasks", "cal.team": "Whole team", "cal.more": "+{n} more",
      ...
      "cal.embedEmpty": "No external calendar has been set up yet. An admin can paste an embed link here.",
      "cal.embedSaved": "Calendar link saved", "cal.embedError": "Could not save the link (must start with http:// or https://)",
      "cal.embedHint": "Some calendars refuse to display inside another page — if it stays blank, open it in a new tab instead.", "cal.embedOpen": "Open in new tab",
      ...
      "do.noCol": "No.", "do.typeCol": "Type", "do.itemCol": "Equipment", "do.shortNameCol": "Short name", "do.brandCol": "Brand", "do.modelCol": "Model", "do.serialCol": "Serial Number",
      "do.qtyCol": "Qty", "do.remarkCol": "Details", "do.noteCol": "Remark", "do.locationCol": "Location", "do.columnsLabel": "Columns to show", "do.addItemRow": "+ Add item",
      "do.addItemTitle": "Add item", "do.editItemTitle": "Edit item", "do.cancel": "Cancel", "do.editItem": "Edit item", "do.removeItem": "Remove item", "do.noItemsYet": "No items yet",
      "do.receivedDateCol": "Received date", "do.warrantyStartCol": "Warranty start date", "do.warrantyEndCol": "Warranty end date",
      "do.addColumn": "+ Add column", "do.newColumnPlaceholder": "New column name", "do.removeColumn": "Remove this column",
      "do.exportExcel": "Export Excel", "do.importExcel": "Import Excel", "do.importExcelSuccess": "Imported {count} row(s) from Excel", "do.importExcelError": "Couldn't read that Excel file",
      ...
      "do.statOrders": "Delivery orders", "do.statItems": "Items",
      ...
      "board.importSubitems": "Import file", "board.importSubitemsTitle": "Import subitems",
      ...
      "panel.edit": "Edit", "panel.deleteUpdateConfirm": "Delete this update? Any replies to it are deleted too. This can't be undone.",
      "panel.deleteReplyConfirm": "Delete this reply? This can't be undone.",
      "panel.updateEdited": "Update saved", "panel.updateDeleted": "Update deleted",
    ...
    th: {
      ...
      "doc.scopedTo": "กำลังแสดงเอกสารของโปรเจกต์ {title}",
      ...
      "cal.googleNone": "เชื่อมต่อ Google Calendar แล้ว แต่ไม่มีกิจกรรมในช่วงวันที่ที่แสดงอยู่ — ลองเลื่อนไปเดือนอื่น", "cal.today": "วันนี้", "cal.mine": "งานของฉัน", "cal.team": "ทั้งทีม", "cal.more": "+อีก {n}",
      ...
      "cal.embedEmpty": "ยังไม่ได้ตั้งค่าปฏิทินภายนอก ผู้ดูแลระบบสามารถวางลิงก์ฝังที่นี่ได้",
      "cal.embedSaved": "บันทึกลิงก์ปฏิทินแล้ว", "cal.embedError": "บันทึกลิงก์ไม่ได้ (ต้องขึ้นต้นด้วย http:// หรือ https://)",
      "cal.embedHint": "ปฏิทินบางเจ้าไม่ยอมแสดงในหน้าอื่น — ถ้าเว้นว่างอยู่ ให้เปิดในแท็บใหม่แทน", "cal.embedOpen": "เปิดในแท็บใหม่",
      ...
      "do.statOrders": "ใบส่งสินค้า", "do.statItems": "รายการอุปกรณ์",
      ...
      "board.importSubitems": "นำเข้าไฟล์", "board.importSubitemsTitle": "นำเข้างานย่อย",
      ...
      "panel.edit": "แก้ไข", "panel.deleteUpdateConfirm": "ลบอัปเดตนี้ใช่ไหม? การตอบกลับทั้งหมดในนี้จะถูกลบไปด้วย — ย้อนกลับไม่ได้",
      "panel.deleteReplyConfirm": "ลบการตอบกลับนี้ใช่ไหม? ย้อนกลับไม่ได้",
      "panel.updateEdited": "บันทึกอัปเดตแล้ว", "panel.updateDeleted": "ลบอัปเดตแล้ว",
